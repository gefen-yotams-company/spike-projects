...
gyro straight: the first value is the amount of time to move. the second is speed% and third is if you want to turn during movement(it will always fix to the wanted degree. even if a previous turn was wrong)
